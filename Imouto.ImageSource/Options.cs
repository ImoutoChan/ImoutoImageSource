...
namespace Imouto.ImageSource
{
    internal static class StringCoda
    {
        ...
        private static int GetNextWidth(IEnumerator<int> widths, int curWidth, ref bool? eValid)
        {
            if (!eValid.HasValue || eValid.Value)
            {
                curWidth = (eValid = widths.MoveNext()).Value ? widths.Current : curWidth;
    ...
    public abstract class Option
    {
        ...
        private static readonly char[] _nameTerminator = new[] { '=', ':' };
        ...
        private OptionValueType ParsePrototype()
        {
            ...
            for (var i = 0; i < Names.Length; ++i)
            {
                ...
                var end = name.IndexOfAny(_nameTerminator);
                if (end == -1)
                    continue;
    ...
    public class OptionSet : KeyedCollection<string, Option>
    {
        ...
        private const int _optionWidth = 29;
        private const int _descriptionFirstWidth = 80 - _optionWidth;
        private const int _descriptionRemWidth = 80 - _optionWidth - 2;
        ...
        public void WriteOptionDescriptions(TextWriter o)
        {
            foreach (var p in this)
            {
                ...
                if (written < _optionWidth)
                {
                    o.Write(new string(' ', _optionWidth - written));
                }
                else
                {
                    o.WriteLine();
                    o.Write(new string(' ', _optionWidth));
                }

                WriteDescription(o, p.Description, new string(' ', _optionWidth + 2),
                        _descriptionFirstWidth, _descriptionRemWidth);
            }
            ...
            foreach (var s in _sources)
            {
                ...
                WriteDescription(o, s.Description, new string(' ', _optionWidth + 2),
                        _descriptionFirstWidth, _descriptionRemWidth);
            }
        }
